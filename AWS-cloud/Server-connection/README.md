...
![Securitygroup](Images/Securitygroups.jpeg)
...
### - Created an IAM role to give s3 permission to ec2 and enabled public access blocking.
### - Update permission to all full s3 access
### - Ensured s3 object is printed directly on the ec2 page as a static page.

![s3page](Images/EC2-S3.jpeg)
